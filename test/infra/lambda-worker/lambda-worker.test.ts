...
describe("LambdaWorker", () => {
  describe("function lambda", () => {
    describe("with only required props", () => {
      ...
      //  Template.fromStack(stack).
      //    hasResource("AWS::CloudWatch::Alarm", {
    ...
    //describe("given an optional topic", () => {
      ...
      //  Template.fromStack(stack).
      //    hasResource("AWS::SNS::Subscription", {
      //      Protocol: "sqs",
      //      TopicArn: {
    ...
    //describe("disabling queue event source", () => {
      ...
      //  Template.fromStack(stack).resourceCountIs("AWS::Lambda::Function", 1);
      //  Template.fromStack(stack).resourceCountIs("AWS::Lambda::EventSourceMapping", 2);

      //  Template.fromStack(stack).
      //    hasResource("AWS::Lambda::EventSourceMapping", {
      //      FunctionName: {
