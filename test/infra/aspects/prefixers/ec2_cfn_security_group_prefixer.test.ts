...
import { Ec2CfnSecurityPrefixer } from "../../../../lib";
...
describe("Lambda CfnSecurityGroup Prefixer", () => {
  ...
  let prefixer: Ec2CfnSecurityPrefixer;
  let emptyPrefixer: Ec2CfnSecurityPrefixer;
  ...
  beforeEach(() => {
    ...
    prefixer = new Ec2CfnSecurityPrefixer(cfnSecurityGroup, "test-prefix-");
    emptyPrefixer = new Ec2CfnSecurityPrefixer(cfnSecurityGroup, "");
  });
  ...
  describe("Undefined Resource", () => {
    test("Raises error if no prefixer defined for resource", () => {
      ...
      expect(() => {
        new Ec2CfnSecurityPrefixer(unknownResource, "prefix");
      }).toThrowError(
